  ...
  try {
    ...
    const profilRenford = await prisma.profilRenford.findUnique({
      ...
      select: {
        ...
        latitude: true,
        longitude: true,
        statutCertification: true,
        dateCertification: true,
        justificatifCarteProfessionnelleChemin: true,
        niveauExperience: true,
        tarifHoraire: true,
        proposeJournee: true,
        tarifJournee: true,
        proposeDemiJournee: true,
        tarifDemiJournee: true,
        stripeConnectAccountId: true,
        stripeConnectOnboardingComplete: true,
        nombreMissionsCompletees: true,
        noteMoyenne: true,
        chiffreAffairesTotal: true,
        portfolio: true,
        dateCreation: true,
        dateMiseAJour: true,
        utilisateur: {
