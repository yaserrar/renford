...
import { useSkipEtablissementStep } from "@/hooks/onboarding";
...
export default function Etape4Page() {
  ...
  return (
    <OnboardingCard
      ...
      subtitle="Partagez ce lien et invitez vos coachs habituels : ils seront notifiés en priorité lorsqu'une mission correspond à leur profil."
    >
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <div className="flex flex-col md:flex-row md:justify-end gap-3 pt-4">
            ...
            <Button
              onClick={() => router.push("/onboarding/etape-5")}
            >
              Suivant
            </Button>
          </div>
