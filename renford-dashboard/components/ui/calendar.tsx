...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        months: `relative flex ${defaultClassNames.month} gap-2`,
        ...
        range_start: cn(
          "bg-accent [&>button]:bg-secondary [&>button]:text-secondary-foreground [&>button]:hover:bg-secondary [&>button]:hover:text-secondary-foreground day-range-start rounded-s-md",
        ...
        range_end: cn(
          "bg-accent [&>button]:bg-secondary [&>button]:text-secondary-foreground [&>button]:hover:bg-secondary [&>button]:hover:text-secondary-foreground day-range-end rounded-e-md",
          classNames?.range_end
        ),
        selected: cn(
          "[&>button]:bg-secondary [&>button]:text-secondary-foreground [&>button]:hover:bg-secondary [&>button]:hover:text-secondary-foreground",
          classNames?.selected
        ),
        today: cn(
