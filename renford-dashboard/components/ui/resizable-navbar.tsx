...
export const Navbar = ({ children, className }: NavbarProps) => {
  ...
  return (
    <motion.div
      ...
      className={cn("sticky inset-x-0 top-6 z-50 w-full", className)}
    >
...
export const NavbarButton = ({
  ...
  const baseStyles =
    "px-4 py-2 rounded-md button bg-neutral-50 text-black text-sm font-bold relative cursor-pointer hover:-translate-y-0.5 transition duration-200 inline-block text-center";
