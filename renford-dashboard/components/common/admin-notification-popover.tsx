...
const AdminNotificationPopover = () => {
  ...
  const notificationsQuery = useAdminNotifications(page, limit);
  const markOneReadMutation = useMarkAdminNotificationRead();
    ...
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent align="start" className="w-[360px] p-0">
        <div className="flex items-center justify-between border-b px-4 py-3">
          <p className="text-sm font-semibold">Notifications admin</p>
          <Button
            variant="ghost"
            size="sm"
